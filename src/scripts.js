...
board.createItem({ item: 'trap', top: TILE_SIZE * 16, left: TILE_SIZE * 7 });
board.createItem({ item: 'trap', top: TILE_SIZE * 30, left: TILE_SIZE * 19 });
board.createItem({ item: 'trap', top: TILE_SIZE * 5, left: TILE_SIZE * 10 });
board.createItem({ item: 'chest', top: TILE_SIZE * 5, left: TILE_SIZE * 17 });
...
board.createEnemy({ top: TILE_SIZE * 2, left: TILE_SIZE * 8 });
board.createEnemy({ top: TILE_SIZE * 8, left: TILE_SIZE * 12 });
board.createEnemy({ top: TILE_SIZE * 16, left: TILE_SIZE * 9 });
board.createEnemy({ top: TILE_SIZE * 15, left: TILE_SIZE * 5 });